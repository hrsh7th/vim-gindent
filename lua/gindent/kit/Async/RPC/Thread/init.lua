...
local Session = require('gindent.kit.Async.RPC.Session')

---@class gindent.kit.Async.RPC.Thread
---@field private thread uv.luv_thread_t
---@field private session gindent.kit.Async.RPC.Session
local Thread = {}
Thread.__index = Thread

---Create new thread.
---@param dispatcher_ fun(session: gindent.kit.Async.RPC.Session)
