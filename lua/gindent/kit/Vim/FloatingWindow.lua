...
---@alias gindent.kit.Vim.FloatingWindow.WindowKind 'main' | 'scrollbar_track' | 'scrollbar_thumb'

---@class gindent.kit.Vim.FloatingWindow.BorderSize
...
---@class gindent.kit.Vim.FloatingWindow.ContentSize
---@field public width integer
---@field public height integer

---@class gindent.kit.Vim.FloatingWindow.WindowConfig
...
---@class gindent.kit.Vim.FloatingWindow.Viewport
...
---@field public border_size gindent.kit.Vim.FloatingWindow.BorderSize
---@field public content_size gindent.kit.Vim.FloatingWindow.ContentSize
...
---@class gindent.kit.Vim.FloatingWindow.Config
---@field public markdown? boolean

---@class gindent.kit.Vim.FloatingWindow
---@field private _augroup string
---@field private _config gindent.kit.Vim.FloatingWindow.Config
...
---@param win? integer
---@param buf integer
---@param win_config gindent.kit.Vim.FloatingWindow.WindowConfig
---@return integer
...
---@return gindent.kit.Vim.FloatingWindow.BorderSize
...
---@return gindent.kit.Vim.FloatingWindow.ContentSize
...
---@param params { border_size: gindent.kit.Vim.FloatingWindow.BorderSize, content_size: gindent.kit.Vim.FloatingWindow.ContentSize, max_outer_width: integer, max_outer_height: integer }
...
---Create window.
---@return gindent.kit.Vim.FloatingWindow
function FloatingWindow.new()
  return setmetatable({
    _augroup = vim.api.nvim_create_augroup(('gindent.kit.Vim.FloatingWindow:%s'):format(kit.unique_id()), {
      clear = true,
    }),
    _config = {
      markdown = false,
...
---Get config.
---@return gindent.kit.Vim.FloatingWindow.Config
function FloatingWindow:get_config()
  return self._config
end

---Set config.
---@param config gindent.kit.Vim.FloatingWindow.Config
...
---@param key string
---@param value any
---@param kind? gindent.kit.Vim.FloatingWindow.WindowKind
...
---@return gindent.kit.Vim.FloatingWindow.Viewport
