local LanguageId = require('gindent.kit.LSP.LanguageId')
...
---@alias gindent.kit.LSP.DocumentSelector.NormalizedFilter { notebook_type: string?, scheme: string?, pattern: string, language: string? }

---Normalize the filter.
---@param document_filter gindent.kit.LSP.DocumentFilter
---@return gindent.kit.LSP.DocumentSelector.NormalizedFilter | nil
local function normalize_filter(document_filter)
  if document_filter.notebook then
    local filter = document_filter --[[@as gindent.kit.LSP.NotebookCellTextDocumentFilter]]
    ...
    local filter = document_filter --[[@as gindent.kit.LSP.TextDocumentFilter]]
    return {
      notebook_type = nil,
...
---@param filter? gindent.kit.LSP.DocumentSelector.NormalizedFilter
---@param uri string
...
---@param bufnr integer
---@param document_selector gindent.kit.LSP.DocumentSelector
