local Buffer = require('gindent.kit.Vim.Buffer')
...
---@alias gindent.kit.LSP.Position.Encoding 'utf8'|'utf16'|'utf32'
Position.Encoding = {}
...
---@param encoding gindent.kit.LSP.Position.Encoding
---@return gindent.kit.LSP.Position
...
---@param position gindent.kit.LSP.Position
