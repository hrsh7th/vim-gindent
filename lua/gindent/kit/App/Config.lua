...
local Cache = require('gindent.kit.App.Cache')

---@class gindent.kit.App.Config.Schema

---@alias gindent.kit.App.Config.SchemaInternal gindent.kit.App.Config.Schema|{ revision: integer }

---@class gindent.kit.App.Config
---@field private _cache gindent.kit.App.Cache
---@field private _default gindent.kit.App.Config.SchemaInternal
---@field private _global gindent.kit.App.Config.SchemaInternal
---@field private _filetype table<string, gindent.kit.App.Config.SchemaInternal>
---@field private _buffer table<integer, gindent.kit.App.Config.SchemaInternal>
local Config = {}
Config.__index = Config

---Create new config instance.
---@param default gindent.kit.App.Config.Schema
...
---@param config gindent.kit.App.Config.Schema
...
---@return gindent.kit.App.Config.Schema
function Config:get()
...
---@return fun(config: gindent.kit.App.Config.Schema)|{ filetype: fun(filetypes: string|string[], config: gindent.kit.App.Config.Schema), buffer: fun(bufnr: integer, config: gindent.kit.App.Config.Schema) }
