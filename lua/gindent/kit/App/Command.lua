---@class gindent.kit.App.Command.SubCommand.Argument
---@field public complete? fun(prefix: string):string[]
---@field public required? boolean

---@class gindent.kit.App.Command.SubCommandSpecifier
---@field public desc? string
---@field public args? table<string|number, gindent.kit.App.Command.SubCommand.Argument>
---@field public execute fun(params: gindent.kit.App.Command.ExecuteParams, arguments: table<string, string>)

---@class gindent.kit.App.Command.SubCommand: gindent.kit.App.Command.SubCommandSpecifier
---@field public name string
---@field public args table<string|number, gindent.kit.App.Command.SubCommand.Argument>

---@class gindent.kit.App.Command
---@field public name string
---@field public subcommands table<string, gindent.kit.App.Command.SubCommand>
local Command = {}
Command.__index = Command

---Create a new command.
---@param name string
---@param subcommand_specifiers table<string, gindent.kit.App.Command.SubCommandSpecifier>
...
---@class gindent.kit.App.Command.ExecuteParams
---@field public name string
...
---Execute command.
---@param params gindent.kit.App.Command.ExecuteParams
